report.html: Report.Rmd code/render_report.R descriptive_analysis reg_analysis
...
output/model_coeffs.rds: code/model.R data/global_sports_footwear_sales_2018_2026.csv
	Rscript code/model.R
	
.PHONY: reg_analysis
regression_analysis: output/model_coeffs.rds
